...
<head>
    ...
    <link rel="canonical" href="https://preview.keenthemes.com/keen/demo5/dashboards/projects.html" />
    <link rel="shortcut icon" href="/admin/assets/media/logos/favicon.ico" />

    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-dyDPrsfrFoDA42Kti3r1Y+Ni5UleF3gk0bPcUzPeLm1IUE9HBsm7I8l8FaAaD5ppRmlz9V5qASJWJ+ojXpL0IQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<body id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-sidebar-stacked="true" data-kt-app-sidebar-secondary-enabled="true" data-kt-app-toolbar-enabled="true" class="app-default">
                ...
                <div class="app-container  container-xxl d-flex align-items-center justify-content-between " id="kt_app_header_container">
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
                        <a href="/keen/demo5/index.html">
                            <img alt="Logo" src="/admin/assets/media/logos/default-small-dark.svg" class="h-30px" />
                        </a>
                    </div>
                    <!--end::Logo-->
                    ...
                    <div class="d-flex align-items-center d-lg-none ms-2" title="Show sidebar menu">
                        <div class="btn btn-icon btn-color-white bg-white bg-opacity-0 bg-hover-opacity-10 w-35px h-35px" id="kt_app_sidebar_mobile_toggle">
                            <i class="fas fa-bars fs-2"></i><span class="path1"></span><span class="path2"></span></i>
                        </div>
                    </div>
                ...
                <div id="kt_app_footer" class="app-footer ">
                    ...
                    <div class="app-container  container-xxl d-flex flex-column flex-md-row flex-center flex-md-stack py-3 ">
                        ...
                        <div class="text-gray-900 order-2 order-md-1">
                            ...
                            <a href="https://keenthemes.com" target="_blank" class="text-gray-800 text-hover-primary">TDBanks</a>
                        </div>
                        <!--end::Copyright-->
                    </div>
    ...
    <div
        ...
        <div class="card border-0 shadow-none rounded-0 w-100">
            ...
            <div
                ...
                style="background-image:url('/admin/assets/media/misc/layout/customizer-header-bg.jpg')">
            ...
            <div class="card-body position-relative" id="kt_app_layout_builder_body">
                ...
                <div id="kt_app_settings_content"
                    ...
                    <!--begin::Form-->
                    <form class="form" method="POST" id="kt_app_layout_builder_form" action="/keen/demo5/index.php">
                                ...
                                <div class="row " data-kt-buttons="true" data-kt-buttons-target=".form-check-image,.form-check-input">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success">
                                            ...
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="/admin/assets/media/preview/demos/demo5/light-ltr.png" class="form-check-rounded mw-100" alt="" />
                                            </div>
                                            <!--end::Image-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="/admin/assets/media/preview/demos/demo5/dark-ltr.png" class="form-check-rounded mw-100" alt="" />
                                            </div>
                                            <!--end::Image-->
                            ...
                            <div class="form-group d-flex flex-stack">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="fs-7 fw-semibold text-muted">
                                        ...
                                        <a href="/keen/demo5/layout-builder.html" class="fw-semibold">
                                            More layout options.
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <div class="form-check form-check-solid form-check-custom form-check-success form-switch">
                                        ...
                                        <input class="form-check-input w-45px h-30px" type="checkbox" checked
                                            value="true" name="layout-builder[layout][app][sidebar][secondary][display]" id="kt_builder_sidebar_secondary" />
    ...
    <div
        ...
        <div class="card shadow-none border-0 rounded-0">
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
                                        <!--begin::Title-->
                                        <a href="/keen/demo5/apps/projects/project.html" class="fs-5 text-gray-900 text-hover-primary fw-semibold w-375px min-w-200px">Meeting with customer</a>
                                        <!--end::Title-->
                                        ...
                                        <!--begin::Action-->
                                        <a href="/keen/demo5/apps/projects/project.html" class="btn btn-sm btn-light btn-active-light-primary">View</a>
                                        <!--end::Action-->
                                    </div>
                                    <!--end::Record-->
                                    ...
                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
                                        <!--begin::Title-->
                                        <a href="/keen/demo5/apps/projects/project.html" class="fs-5 text-gray-900 text-hover-primary fw-semibold w-375px min-w-200px">Project Delivery Preparation</a>
                                        <!--end::Title-->
                                    ...
                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <div class="ms-1 fw-semibold">
                                                <!--begin::Desc-->
                                                <a href="/keen/demo5/apps/projects/project.html" class="fs-6 text-hover-primary fw-bold">Finance KPI App Guidelines</a>
                                                <!--end::Desc-->
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img alt="/keen/demo5/apps/projects/project.html" class="w-30px me-3" src="/admin/assets/media/svg/files/doc.svg" />
                                            <!--end::Icon-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            <!--begin::Icon-->
                                            <img alt="/keen/demo5/apps/projects/project.html" class="w-30px me-3" src="/admin/assets/media/svg/files/css.svg" />
                                            <!--end::Icon-->
            ...
            <div class="card-footer py-5 text-center" id="kt_activities_footer">
                <a href="/keen/demo5/pages/user-profile/activity.html" class="btn btn-bg-body text-primary">
                    ...
                    <div class="d-flex justify-content-start mb-10 ">
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <!--begin::Avatar-->
                                <div class="symbol  symbol-35px symbol-circle "><img alt="Pic" src="/admin/assets/media/avatars/300-25.jpg" /></div><!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-3">
                    ...
                    <div class="d-flex justify-content-end mb-10 ">
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <!--begin::Avatar-->
                                <div class="symbol  symbol-35px symbol-circle "><img alt="Pic" src="/admin/assets/media/avatars/300-1.jpg" /></div><!--end::Avatar-->
                            </div>
                            <!--end::User-->
            ...
            <div class="card-body hover-scroll-overlay-y h-400px pt-5">
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->
                        <div class="mb-3">
                            <a href="/keen/demo5/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">Iblender</a>
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->
                        <div class="mb-3">
                            <a href="/keen/demo5/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">SmartCleaner</a>
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->
                        <div class="mb-3">
                            <a href="/keen/demo5/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">CameraMaxr</a>
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->
                        <div class="mb-3">
                            <a href="/keen/demo5/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">$D Printer</a>
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->
                        <div class="mb-3">
                            <a href="/keen/demo5/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">MotionWire</a>
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->
                        <div class="mb-3">
                            <a href="/keen/demo5/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">Samsung</a>
        ...
        <div class="card shadow-none rounded-0 w-100">
            ...
            <div class="card-body" id="kt_help_body">
                ...
                <div
                    ...
                    <!--end::Link-->
                    <!--begin::Link-->
                    <a href="/keen/demo5/layout-builder.html" class="parent-hover d-flex align-items-center mb-7">
                        <!--begin::Icon-->
                                        ...
                                        <div class="mh-300px scroll-y me-n7 pe-7">
                                            ...
                                            <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px">
                                                        <img src="/admin/assets/media/svg/files/pdf.svg" alt="icon" />
                                                    </div>
                                                    <!--end::Avatar-->
                                            ...
                                            <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px">
                                                        <img src="/admin/assets/media/svg/files/tif.svg" alt="icon" />
                                                    </div>
                                                    <!--end::Avatar-->
                                            ...
                                            <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px">
                                                        <img src="/admin/assets/media/svg/files/folder-document.svg" alt="icon" />
                                                    </div>
                                                    <!--end::Avatar-->
                                            ...
                                            <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px">
                                                        <img src="/admin/assets/media/svg/files/css.svg" alt="icon" />
                                                    </div>
                                                    <!--end::Avatar-->
                                            ...
                                            <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px">
                                                        <img src="/admin/assets/media/svg/files/ai.svg" alt="icon" />
                                                    </div>
                                                    <!--end::Avatar-->
                                            ...
                                            <div class="d-flex flex-stack py-4 ">
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px">
                                                        <img src="/admin/assets/media/svg/files/doc.svg" alt="icon" />
                                                    </div>
                                                    <!--end::Avatar-->
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <!--begin::Tagify-->
                                        <input class="form-control d-flex align-items-center" value="" id="kt_modal_create_campaign_location" data-kt-flags-path="/admin/assets/media/flags/" />
                                        <!--end::Tagify-->
                                    </div>
                                    <!--end::Input group-->
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="text-center px-4">
                                        <img src="/admin/assets/media/illustrations/sketchy-1/9.png" alt="" class="mww-100 mh-350px" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                            </div>
    ...
    <!--end::Modal - Upgrade plan--><!--begin::Modal - New Address-->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="btn btn-light-primary fw-bold w-100 mb-8">
                        <img alt="Logo" src="/admin/assets/media/svg/brand-logos/google-icon.svg" class="h-20px me-3" />
